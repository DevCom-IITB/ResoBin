  ...
  const savePersonalData = async () => {
    ...
    try {
      ...
      if (editingId) {
        ...
        const updatedItem = await EplannerAPI.updatePersonal(
          editingId,
          itemData
        )
        setPersonalItems(
      ...
      toast({
        ...
        content: editingId
          ...
          : 'Personal event saved successfully!',
        key: 'personal-save-success',
      })
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <div
                  style={{ display: 'flex', width: '8%', marginTop: '15px' }}
                >
                  <svg
                    width="25"
                    height="24"
            ...
            <div>
              ...
              >
                {' '}
                Your Personal Tasks ({personalItems.length})
              </h3>
                      ...
                      >
                        ...
                        <button
                          ...
                          style={{
                            ...
                            border: 'none',
                            color:
                              editingId === item.id ? '#8080FF' : '#4ECDC4',
                            fontSize: '14px',
                            cursor: loading ? 'not-allowed' : 'pointer',
                            padding: '3px',
                            borderRadius: '3px',
...
const PersonalPlanner = ({ hideButton, selectedDate }) => {
  return <PersonalCard hideButton={hideButton} selectedDate={selectedDate} />
}
