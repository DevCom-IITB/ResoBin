            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <h3 style={{ marginBottom: '15px', color: 'white' }}>Add courses</h3>
                  ...
                  <div style={{ marginBottom: '15px', display :"flex", flexDirection: "row", gap: '15px' }}>
                    ...
                    <div style={{ marginTop: '10px'}}>
                      <svg width="25" height="24" viewBox="0 0 24 24" fill="none">
                        <circle cx="11" cy="11" r="8" stroke="#9ca3af" strokeWidth="2" fill="none"/>
                    ...
                    <select
                      ...
                      required
                    >
                      <option value="" style={{ color: '#9ca3af' }}>Select a course...</option>
                      {coursesList.map((courseItem, index) => {
                        const courseName = courseItem.course || courseItem.name || courseItem.title || courseItem.coursename || courseItem.code;
                        return (
                          <option key={courseItem.id || index} value={courseName} style={{ color: 'white' }}>
                            {courseName}
                          </option>
                        );
                      })}
