  ...
  const saveReminderData = async () => {
    ...
    try {
      ...
      if (editingId) {
        ...
        const updatedItem = await EplannerAPI.updateReminder(
          editingId,
          itemData
        )
        setReminderItems(
        ...
        >
          ...
          >
                  ...
                  <div
                    ...
                    onKeyDown={(e) => {
                      if (e.key === 'Enter' || e.key === ' ') {
                        e.preventDefault()
                        document
                          .getElementById('eplanner-starttime')
                          .showPicker()
                      }
                    }}
                  >
            ...
            <div style={{ marginBottom: 'auto' }}>
              ...
              >
                {' '}
                Your Reminders ({ReminderItems.length})
              </h3>
                      ...
                      >
                        ...
                        <button
                          ...
                          style={{
                            ...
                            border: 'none',
                            color:
                              editingId === item.id ? '#8080FF' : '#FF6B6B',
                            fontSize: '14px',
                            cursor: loading ? 'not-allowed' : 'pointer',
                            padding: '3px',
                            borderRadius: '3px',
...
const ReminderPlanner = ({ hideButton, selectedDate }) => {
  return <ReminderCard hideButton={hideButton} selectedDate={selectedDate} />
}
