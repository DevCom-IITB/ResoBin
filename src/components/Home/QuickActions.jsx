...
const QuickActions = () => {
  ...
  const actions = [
    { id: "add-event", icon: <FiCalendar />, title: "Add Event", subtitle: "sync it to your timetable", onClick: () => navigate("/timetable/month", { state: { autoOpen: "personal" } }) },
    { id: "set-reminder", icon: <FiBell />, title: "Set Reminder", subtitle: "Stay on track", onClick: () => navigate("/timetable/day", { state: { autoOpen: "reminder" } }) },
