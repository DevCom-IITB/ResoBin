  ...
  return (
    <>
      ...
      <Aside title="Instructions" loading={loading}>
        ...
        <ul>
          <li>Please ensure that the resources you upload are not duplicates of existing resources.</li>
          <li>Please name the files sensibly. Avoid using the course name, professor name, year, your name, roll number, etc in the file<span>&#39;</span>s name. Convert the files to pdf if possible.</li>
          <li>Select the year, professor name and module name as applicable. If there is no module available, please reach out to us. Providing this data helps us serve these resources in an organized way.</li>
          <li>Files larger than 30MB cannot be uploaded through the portal. If you have larger files, please send them to us via email.</li>          
        </ul>
