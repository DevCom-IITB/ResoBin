  ...
  return (
    <PageContainer>
      ...
      <Content>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to DevCom, IIT Bombay.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to ResoBin, accessible from&nbsp;
              <a
                href="https://resobin.gymkhana.iitb.ac.in"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                https://resobin.gymkhana.iitb.ac.in
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: devcom@iitb.ac.in</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:&nbsp;
              <a
                href="https://resobin.gymkhana.iitb.ac.in/contact"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                https://resobin.gymkhana.iitb.ac.in/contact
              </a>
            </p>
          </li>
        </ul>
